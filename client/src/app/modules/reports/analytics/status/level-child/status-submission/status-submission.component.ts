...
@Component({
  selector: 'app-status-submission',
  templateUrl: './status-submission.component.html',
  styleUrls: ['./status-submission.component.scss']
})
export class StatusSubmissionComponent implements OnInit {
  @Input() dataToLoad;
  @Input() reportInfo;
