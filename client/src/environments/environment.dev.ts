export const environment = {
  ...
  redirect_uri: 'https://spotlight-dev.corporate.ge.com/login',
  ...
  logOutURL:
    'https://ssologin.ssogen2.corporate.ge.com/logoff/logoff.jsp?referrer=https://spotlight-dev.corporate.ge.com/login?logout=true',
