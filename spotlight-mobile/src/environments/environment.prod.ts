export const environment = {
  ...
  redirect_uri: 'https://spotlight.corporate.ge.com/mobile/login',
  ...
  logOutURL:
    'https://ssologin.ssogen2.corporate.ge.com/logoff/logoff.jsp?referrer=https://spotlight.corporate.ge.com/mobile/login',
